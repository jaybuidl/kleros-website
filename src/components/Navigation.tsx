...
export const Navigation: React.FC = () => {
  return (
    <nav className="relative bg-[rgba(34,0,80,0)] flex w-full flex-col items-center text-base justify-center py-4 max-md:max-w-full animate-fade-in">
      <div className="flex w-full max-w-[1184px] items-stretch gap-5 flex-wrap justify-between max-md:max-w-full pl-32 pr-8 max-md:pl-5 max-md:pr-5">
        <img
        ...
        <div className="flex items-center gap-8 text-white whitespace-nowrap justify-center my-auto max-md:max-w-full">
          <div className="flex flex-col self-stretch relative aspect-[3.05] w-[61px] my-auto">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/1b9b30492992499490f097b922f340b2/47f58808777cfd70f3d94a5b69fa523b096e0096?placeholderIfAbsent=true"
          ...
          <div className="flex flex-col self-stretch relative aspect-[4.75] w-[95px] my-auto">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/1b9b30492992499490f097b922f340b2/2f345268062d321082d41b8c34a4f5b81eaae56b?placeholderIfAbsent=true"
              className="absolute h-full w-full object-cover inset-0"
