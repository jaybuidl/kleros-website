...
const ParticipationCard: React.FC<ParticipationCardProps> = ({ title, description }) => {
  return (
    <div className="min-w-60 grow shrink w-[463px] max-md:max-w-full">
      <div className="border border-[color:var(--Color-Schemes-Stroke,#42498F)] shadow-[0px_2px_3px_0px_rgba(0,0,0,0.06)] flex flex-col bg-[#220050] pt-6 pb-[107px] px-6 rounded-2xl border-solid hover:border-[#27CDFE] transition-colors max-md:max-w-full max-md:pb-[100px] max-md:px-5">
        <div className="mb-[-21px] h-[188px] w-[330px] max-w-full max-md:mb-2.5">
          <div className="flex w-full flex-col items-stretch text-[32px] text-[#DAF0FF] font-medium justify-center">
            ...
            <h3 className="text-[#DAF0FF] mt-4">
              {title}
            </h3>
          </div>
          <p className="text-[#BECCE5] text-2xl font-normal mt-6 max-md:max-w-full">
            {description}
          </p>
        </div>
      </div>
    ...
    <section className="items-stretch flex w-full flex-col justify-center bg-[#220050] px-32 py-24 max-md:max-w-full max-md:px-5">
      <div className="flex w-full max-w-[1182px] flex-col items-stretch max-md:max-w-full">
        <div className="w-full">
          ...
          <p className="text-[#BECCE5] text-2xl font-normal mt-8 max-md:max-w-full">
        ...
        <div className="flex gap-8 text-2xl text-[#27CDFE] font-normal text-center mt-12 max-md:max-w-full max-md:mt-10">
          <button className="flex items-center gap-2 hover:text-[#1fb8e8] transition-colors">
        ...
        <div className="w-full text-center mt-12 max-md:mt-10">
          <div className="flex flex-col justify-center items-center overflow-hidden relative min-h-[187px] w-full px-20 py-[34px] max-md:max-w-full max-md:px-5">
            <img
            ...
            <div className="relative flex flex-col items-center max-md:max-w-full">
              <h3 className="text-[#DAF0FF] text-[32px] font-medium max-md:max-w-full">
                Buy PNK to become a juror in the Kleros court.
              </h3>
              <button className="self-stretch bg-[#27CDFE] min-h-12 gap-2 text-base text-[#1B003F] font-normal mt-8 px-8 py-3.5 rounded-[300px] hover:bg-[#1fb8e8] transition-colors max-md:px-5">
                Start Now
              </button>
            </div>
          </div>
