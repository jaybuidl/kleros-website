...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, linkText, linkIcon }) => {
  return (
    <div className="min-w-60 grow shrink w-[302px]">
      <div className="flex flex-col items-center aspect-[1] bg-[#220050] pt-6 pb-[152px] px-6 rounded-2xl hover:bg-[#2a0060] transition-colors max-md:pb-[100px] max-md:px-5">
        <div className="flex mb-[-30px] h-[188px] w-full flex-col items-stretch max-md:mb-2.5">
          ...
          <p className="text-[#BECCE5] mt-6">
            {description}
          </p>
          <div className="border bg-[#42498F] min-h-0 max-w-full w-[330px] mt-6 border-[rgba(66,73,143,1)] border-solid" />
          <button className="flex items-center gap-4 text-[#27CDFE] text-center justify-center mt-6 hover:text-[#1fb8e8] transition-colors">
  ...
  return (
    <section className="w-full bg-[#1B003F] px-32 py-24 max-md:max-w-full max-md:px-5">
      ...
      <div className="flex max-w-full w-[1182px] flex-col items-center text-2xl font-normal mt-[65px] max-md:mt-10">
        ...
        <div className="flex w-full max-w-[1182px] flex-col items-center text-center mt-12 max-md:max-w-full max-md:mt-10">
