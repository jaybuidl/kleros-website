...
export const Navigation: React.FC = () => {
  return <nav className="relative bg-[rgba(34,0,80,0)] flex w-full flex-col items-center text-base justify-center py-4 max-md:max-w-full animate-fade-in">
      <div className="flex w-full items-stretch gap-5 flex-wrap justify-between max-md:max-w-full px-32  max-md:pl-5 max-md:pr-5">
        ...
        <div className="flex items-center gap-6 text-white justify-center my-auto max-md:max-w-full">
          <div className="flex items-center justify-center min-w-[61px]">
            ...
            <button className="relative px-2 py-1 hover:text-[#27CDFE] transition-all duration-300 hover:scale-105">
              Apps
            </button>
          </div>
          <div className="flex items-center justify-center min-w-[40px]">
            <button className="px-2 py-1 hover:text-[#27CDFE] transition-all duration-300 hover:scale-105">
              Earn
            </button>
          </div>
          ...
          <div className="flex items-center justify-center min-w-[95px] relative">
