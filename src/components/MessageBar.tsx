    ...
    <div className="w-full max-md:max-w-full">
      <div className="flex w-full items-stretch gap-5 flex-wrap justify-between bg-[#9747FF] pl-20 pr-8 py-[11px] max-md:max-w-full max-md:px-5">
        <div className="flex items-center gap-4 justify-center">
          <div className="text-white text-base font-normal text-center self-stretch my-auto">
            Buy PNK & join the justice revolution
          </div>
          <div className="self-stretch flex items-center gap-2 justify-center w-6 my-auto">
            <img
        ...
        <button className="aspect-[1] object-contain w-4 shrink-0 my-auto">
          <img
