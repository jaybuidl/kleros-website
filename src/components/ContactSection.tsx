    ...
    <section className="items-stretch flex w-full flex-col justify-center bg-[#1B003F] px-32 py-24 max-md:max-w-full max-md:px-5">
      <div className="flex max-w-full w-[1177px] gap-[40px_65px] flex-wrap">
        ...
        <img
          ...
          className="aspect-[1.11] object-contain w-[237px] min-w-60 grow shrink animate-fade-in animation-delay-500 hover:scale-105 transition-transform duration-300"
